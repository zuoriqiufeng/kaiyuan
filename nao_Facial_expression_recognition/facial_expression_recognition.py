...
if __name__ == "__main__":
    ...
    parser.add_argument("--ip", type=str, default="192.168.43.23",
                        help="Robot IP address. On robot or Local Naoqi: use '192.168.43.23'.")
    parser.add_argument("--port", type=int, default=9559,
                        help="Naoqi port number")
#                        help="Robot IP address. On robot or Local Naoqi: use '169.254.60.49'.")
